...
// sub-list represents a structure, and all structures must have the same number
// of elements. Corresponding elements across structures (e.g. the third element
// of every tensor_structures[i]) must have the same rank and dtype.
